...
public class DomainFragment extends Fragment {
	...
	public DomainFragment(String type) {
		mType = type;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		TextView tv1 = (TextView) rootView.findViewById(R.id.tv_domain1);
		TextView tv2 = (TextView) rootView.findViewById(R.id.tv_domain2);
